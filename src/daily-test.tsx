...
export default function DailyTest({ user }: { user: any }) {
  ...
  const sortedTests = useMemo(() => {
    ...
    copy.sort((a, b) => {
      ...
      switch (sortKey) {
        case "date":
          cmp = new Date(a.testDate || 0).getTime() - new Date(b.testDate || 0).getTime() || a.testName.localeCompare(b.testName);
          break;
        case "name":
        ...
        case "status": {
          ...
          cmp = aDone - bDone || a.testName.localeCompare(b.testName);
          break;
        }
      }
      return sortDir === "asc" ? cmp : -cmp;
          ...
          <CardHeader className="pb-2">
            <div className="flex justify-between items-start">
              <Badge variant="outline" className="text-[10px] font-bold">
                {t.testDate ? new Date(t.testDate).toLocaleDateString() : "Daily Sprint"}
              </Badge>
              {attempted ? (
            ...
            <CardTitle className="text-base mt-2">{t.testName || "Daily Practice Test"}</CardTitle>
          </CardHeader>
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <Card className="border-2 border-primary/20">
          <CardHeader className="bg-primary/5 rounded-t-xl">
            ...
            <CardTitle className="text-2xl">{selectedTest.testName || "Daily Practice Test"}</CardTitle>
          </CardHeader>
        ...
        <div className="sticky top-0 z-20 bg-background/95 backdrop-blur border-b shadow-sm">
          <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium hidden sm:block truncate max-w-[200px]">{selectedTest.testName || "Daily Practice Test"}</span>
            </div>
      ...
      return (
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold">{selectedTest.testName} · Review</span>
          </div>
          <div className="space-y-4">
            {questions.map((q, idx) => {
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <Card className="border-2 border-primary/20 overflow-hidden">
          <div className="bg-primary px-6 py-5 text-white">
            ...
            <h2 className="text-2xl font-black mt-1">{selectedTest.testName || "Daily Practice Test"}</h2>
          </div>
